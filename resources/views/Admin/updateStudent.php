<html>
    ...
    <body> 
        <div class="top-employeeform " style="background-color:#00838f  ; light-orange">
            <p style="text-align:left; color:white; font-size: 40px;  vertical-align: auto; padding-left: 10px; margin:0;"> Update Student Detail </p>
                ...
                <div class="col m10 offset-m1 s12">
                    ...
                    <div class="row">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="row">
                                <div class="col m5">
                                    <p class="right-align"><button id="search-employee-profile" class="btn btn-large waves-effect waves-light midddle" style="background-color:#00838f" type="submit" value="submit" name="search">Search Student Profile</button></p>
                                </div>
                            </div> 
                        </form>
                        <form action="" method="post">
                            ...
                            <div class="row">
                                <div class="input-field nom col m6 s12">
                                    <input  value="" id="Tel-home" name="Tel_number" type="tel" class="validate">
                                    <label for="Tel-home">Tel-home</label>
                                </div>

                                <div class="input-field nom col m6 s12">
                                    <input  value="" id="Tel-mobile" name="Tel_mobile" type="tel" class="validate">
                            ...
                            <div class="row">
                                ...
                                <div class="col m5">
                                    <p class="right-align"><button id="upate-employee-profile" class="btn btn-large waves-effect waves-light midddle" style="background-color:#00838f" type="submit" value="submit" name="update">Update Student Profile</button></p>
                                </div>
                            </div> 
                        </form>
                    </div>
